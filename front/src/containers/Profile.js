 ...
 <div className="thumbnail_container">
    ...
    <p className="text-p">
      {this.props.userdata.bio}
        ...
        <a href={this.props.userdata.instagram}><i className="fa fa-instagram sharad2-profile"></i></a>
        <a href={this.props.userdata.linkedin}><i className="fa fa-linkedin sharad2-profile"></i></a>
        <a href={this.props.userdata.github}><i className="fa fa-github sharad2-profile"></i></a>
        <a href={this.props.userdata.facebook}><i className="fa fa-facebook sharad2-profile"></i></a>
